...
like_button ="<button class='btn btn-warning' style='font-size: 20px' id="+firebase_message_id+" value="+like+" onclick='updateLike(this.id)'>";
...
function logout() {
    ...
    localStorage.removeItem("room_name");
    window.location.replace("batatawett.html");
    }